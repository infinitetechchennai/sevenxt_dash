    ...
    try:
        ...
        for index, row in df.iterrows():
            try:
                ...
                info = safe_str(get_value(row, ['info', 'product_info', 'short_description', 'summary']))
                description = safe_str(get_value(row, ['description', 'desc', 'product_description', 'details']))
                colors = safe_str(get_value(row, ['colors', 'color', 'product_colors', 'available_colors']))
                brand_name = safe_str(get_value(row, ['brand_name', 'brandname', 'brand', 'manufacturer']))
